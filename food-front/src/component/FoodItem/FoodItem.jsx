...
const FoodItem = ({id,name,price,description,imagge}) => {

  const {cartItem,addCart,removeCartItem} = useContext(StoreContext);


  return (
    <div className='food-item'>
      <div className="food-item-img-container">
        <img className='food-item-img' src={imagge} alt="" />
        {!cartItem[id]
